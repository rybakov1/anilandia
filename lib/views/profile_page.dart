              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    Padding(
                      padding:
                          const EdgeInsets.only(top: 24, left: 8, bottom: 15),
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(
                    ...
                    const Divider(color: utils.dividerDark_1)
                  ],
                ),
              ),
            ),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const Divider(color: utils.dividerDark_2)
                  ],
                ),
              ),
            ),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const Divider(color: utils.dividerDark_3)
                  ],
                ),
              ),
            ),
